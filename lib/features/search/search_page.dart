          ...
          children: [
            ...
            NoScrollGlow(
              child: Expanded(
                child: ListView(
                  children: [
                    AppSearchItem(resultTitle: 'هندزفری بلوتوث Energize', resultLocation: 'در دسته هدفون'),
                    AppSearchItem(resultTitle: 'Beats Headset C105', resultLocation: 'در دسته هدفون'),
                    AppSearchItem(resultTitle: 'هندزفری D12 Blazer', resultLocation: 'در دسته هدفون'),
                    AppSearchItem(resultTitle: 'هندزفری D12 Blazer', resultLocation: 'در دسته هدفون'),
                    AppSearchItem(resultTitle: 'هندزفری D12 Blazer', resultLocation: 'در دسته هدفون'),
                    AppSearchItem(resultTitle: 'هندزفری D12 Blazer', resultLocation: 'در دسته هدفون'),
                    AppSearchItem(resultTitle: 'هندزفری D12 Blazer', resultLocation: 'در دسته هدفون'),

...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i5.Deal) {
      return _i5.Deal.fromJson(data, this) as T;
    }
    if (t == _i6.Product) {
    ...
    if (t == _i1.getType<_i5.Deal?>()) {
      return (data != null ? _i5.Deal.fromJson(data, this) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'Deal') {
      return deserialize<_i5.Deal>(data['data']);
    }
